...
export function Profile() {
  return (
    <ProfileContainer as="section" borderRadius="9px" height="100%">
      <Flex paddingY={6} paddingX={2} borderRadius="9px" alignItems="center">
        <Image src="https://github.com/diebraga.png" w="148px" h="148px" />
        <Flex flexDir="column" w="100%" ml="5" h="148px">
          ...
          <Text color="#AFC2D4" flexGrow={1} w="90%">
            Tristique volutpat pulvinar vel massa, pellentesque egestas. Eu
            viverra massa quam dignissim aenean malesuada suscipit. Nunc,
            volutpat pulvinar vel mass.
          </Text>
          <HStack as="ul" color="#C4D4E3" spacing={4} fontSize="sm">
            <Box>
